...
public class ChargedDynamiteTileEntity extends TileEntity implements ITickableTileEntity{
	...
	public ChargedDynamiteTileEntity() {
		super(ModTileEntityTypes.CHARGED_DYNAMITE.get());
	}
	...
	public void explode() {
	    ...
	    this.world.createExplosion(null, this.getPos().getX() + explosionX, this.getPos().getY() + explosionY, this.getPos().getZ() + explosionZ, 3.0F, Explosion.Mode.BREAK);
