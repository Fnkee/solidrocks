...
public class ModItemModelProvider extends ItemModelProvider {
	...
	protected void registerModels() {
		...
		getBuilder("flimsy_torch").parent(itemGenerated).texture("layer0", "block/flimsy_torch");
		getBuilder("used_torch").parent(itemGenerated).texture("layer0", "block/used_torch");
		getBuilder("smoldering_torch").parent(itemGenerated).texture("layer0", "block/smoldering_torch");
		getBuilder("burnt_out_torch").parent(itemGenerated).texture("layer0", "block/burnt_out_torch");
	}
