...
public class EventHandler {
	...
	public static void clientRegister() {
		...
		RenderTypeLookup.setRenderLayer(ModBlocks.FLIMSY_WALL_TORCH.get(), RenderType.getCutout());
		RenderTypeLookup.setRenderLayer(ModBlocks.USED_WALL_TORCH.get(), RenderType.getCutout());
		RenderTypeLookup.setRenderLayer(ModBlocks.SMOLDERING_WALL_TORCH.get(), RenderType.getCutout());
		RenderTypeLookup.setRenderLayer(ModBlocks.BURNT_OUT_WALL_TORCH.get(), RenderType.getCutout());
	}
}
